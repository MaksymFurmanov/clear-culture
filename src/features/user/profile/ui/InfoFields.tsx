...
import { isVerified } from "@/src/lib/actions/email-confirmaion";
import NameForm from "@/src/features/user/profile/ui/NameForm";
import ChangePasswordBtn from "@/src/features/user/profile/ui/ChangePasswordBtn";
import VerifyEmailBtn from "@/src/features/user/profile/ui/VerifyEmailBtn";
  ...
  return (
    <div className={"flex flex-col gap-3 mt-6 mb-12"}>
      <div
        ...
        {!verified && <VerifyEmailBtn />}
      </div>

      <NameForm defaultValue={user.name} />

      {authWith === "credentials" && <ChangePasswordBtn />}
    </div>
  );
}
